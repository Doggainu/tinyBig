  ...
  return (
    <>
      ...
      <header className="uni-card px-5 py-5 text-center">
        ...
        <h1 className="uni-title mt-2 text-3xl">Farm tB</h1>
        <p className="uni-body mt-2 text-sm">
          Live checklist tied to your wallet. More points = stronger{" "}
          <span className="uni-text-accent font-semibold">tB</span> farm story.
        </p>
      </header>
      ...
      {!hubReady && (
        <div className="uni-card uni-card-critical px-4 py-4">
          <p className="uni-caption">
            Deploy Hub on Base to start earning on-chain points.
          </p>
        </div>
      )}
      ...
      {isConnected && !wrongChain && hubReady && (
        <>
          ...
          {tab === "calc" && (
            <div className="flex flex-col gap-3">
              ...
              <p className="uni-caption text-center opacity-80">
                Points are in-app score for tB narrative — not a token guarantee.
              </p>
            </div>
          )}
      ...
      {!isConnected && hubReady && (
        <p className="uni-caption text-center">
          Connect wallet to see your live farm checklist.
        </p>
      )}
    </>
  );
